    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl animate-in zoom-in-95 duration-500">
          <h2 className="text-xl font-black text-white mb-1">Doctor Login</h2>
          <p className="text-slate-400 text-sm mb-7">
            Sign in to access your patient portal and schedule.
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Field>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-12 h-12 bg-slate-800 border-slate-700 text-white placeholder:text-slate-600 focus:border-emerald-500 focus:ring-emerald-500/20 rounded-xl text-sm"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full h-12 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold rounded-xl flex items-center justify-center gap-2.5 transition-all duration-200 active:scale-[0.98] shadow-lg shadow-emerald-600/20 mt-2"
            >
              {submitting ? (
                <>
        ...
        {/* Access note */}
        <div className="mt-5 mx-1 flex items-start gap-2.5 p-4 bg-slate-900/60 border border-slate-800 rounded-xl">
          <Stethoscope size={15} className="text-emerald-500 shrink-0 mt-0.5" />
          <p className="text-xs text-slate-500 leading-relaxed">
            Doctor accounts are created by your administrator.{' '}
            <span className="text-slate-400 font-medium">Contact admin if you need access.</span>
          </p>
        </div>
